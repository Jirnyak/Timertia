...
async def market(update, context):
    ...
    market_log.write("\n" + str(date) + "," + str(prix_R) + "," +str(prix_G) + "," + str(prix_B))
    market_log.close()
...
async def buy(update, context):
    ...
    for k in range(len(players_list)):
        if str(update.effective_user.id) == players_list[k]:
            found = 1
            if ("r" in message or "R" in message) and int(market_list[0])-amount >= 0 and float(players_list[k+1]) - market_mult(market_list[3])*amount*1000/math.sqrt(int(market_list[0])+1) > 0:
                players_list[k+1] = str(float(players_list[k+1]) - market_mult(market_list[3])*amount*1000/math.sqrt(int(market_list[0])+1))
                players_list[k+2] = str(int(players_list[k+2]) + amount)
                market_list[0] = str(int(market_list[0])-amount)
                market_list[3] = str(float(market_list[3])+market_mult(market_list[3])*amount*1000/math.sqrt(int(market_list[0])+1))
                ...
                messages.append(y.message_id) 
            elif ("g" in message or "R" in message) and int(market_list[1])-amount >= 0 and float(players_list[k+1]) - market_mult(market_list[3])*amount*1000/math.sqrt(int(market_list[1])+1) > 0:
                players_list[k+1] = str(float(players_list[k+1]) - market_mult(market_list[3])*amount*1000/math.sqrt(int(market_list[1])+1))
                players_list[k+3] = str(int(players_list[k+3]) + amount)
                market_list[1] = str(int(market_list[1])-amount)
                market_list[3] = str(float(market_list[3])+market_mult(market_list[3])*amount*1000/math.sqrt(int(market_list[1])+1))
                y = await context.bot.send_message(update.effective_chat.id, text="Господин, " + str(update.effective_user.first_name) + ", ваш капитал:\n" + players_list[k+1] + "$ R: " + players_list[k+2] + " G: " + players_list[k+3] + " B: " + players_list[k+4])
                messages.append(y.message_id) 
            elif ("b" in message or "B" in message) and int(market_list[2])-amount >= 0 and float(players_list[k+1]) - market_mult(market_list[3])*amount*1000/math.sqrt(int(market_list[2])+1) > 0:
                players_list[k+1] = str(float(players_list[k+1]) - market_mult(market_list[3])*amount*1000/math.sqrt(int(market_list[2])+1))
                players_list[k+4] = str(int(players_list[k+4]) + amount)
                market_list[2] = str(int(market_list[2])-amount)
                market_list[3] = str(float(market_list[3])+market_mult(market_list[3])*amount*1000/math.sqrt(int(market_list[2])+1))
                y = await context.bot.send_message(update.effective_chat.id, text="Господин, " + str(update.effective_user.first_name) + ", ваш капитал:\n" + players_list[k+1] + "$ R: " + players_list[k+2] + " G: " + players_list[k+3] + " B: " + players_list[k+4])
                messages.append(y.message_id) 
            else:
...
async def sell(update, context):
    ...
    for k in range(len(players_list)):
        if str(update.effective_user.id) == players_list[k]:
            found = 1
            if ("r" in message or "R" in message) and int(players_list[k+2])-amount >= 0 and float(market_list[3])-market_mult(market_list[3])*0.9*amount*1000/math.sqrt(int(market_list[0])+1) >= 0:
                players_list[k+1] = str(float(players_list[k+1]) + market_mult(market_list[3])*0.9*amount*1000/math.sqrt(int(market_list[0])+1))
                players_list[k+2] = str(int(players_list[k+2]) - amount)
                market_list[0] = str(int(market_list[0])+amount)
                market_list[3] = str(float(market_list[3])-market_mult(market_list[3])*0.9*amount*1000/math.sqrt(int(market_list[0])+1))
                y = await context.bot.send_message(update.effective_chat.id, text="Господин, " + str(update.effective_user.first_name) + ", ваш капитал:\n" + players_list[k+1] + "$ R: " + players_list[k+2] + " G: " + players_list[k+3] + " B: " + players_list[k+4])
                messages.append(y.message_id) 
            elif ("g" in message or "G" in message) and int(players_list[k+3])-amount >= 0 and float(market_list[3])-market_mult(market_list[3])*0.9*amount*1000/math.sqrt(int(market_list[1])+1) >= 0:
                players_list[k+1] = str(float(players_list[k+1]) + market_mult(market_list[3])*0.9*amount*1000/math.sqrt(int(market_list[1])+1))
                players_list[k+3] = str(int(players_list[k+3]) - amount)
                market_list[1] = str(int(market_list[1])+amount)
                market_list[3] = str(float(market_list[3])-market_mult(market_list[3])*0.9*amount*1000/math.sqrt(int(market_list[1])+1))
                y = await context.bot.send_message(update.effective_chat.id, text="Господин, " + str(update.effective_user.first_name) + ", ваш капитал:\n" + players_list[k+1] + "$ R: " + players_list[k+2] + " G: " + players_list[k+3] + " B: " + players_list[k+4])
                messages.append(y.message_id) 
            elif ("b" in message or "B" in message) and int(players_list[k+4])-amount >= 0 and float(market_list[3])-market_mult(market_list[3])*0.9*amount*1000/math.sqrt(int(market_list[2])+1) >= 0:
                players_list[k+1] = str(float(players_list[k+1]) + market_mult(market_list[3])*0.9*amount*1000/math.sqrt(int(market_list[2])+1))
                players_list[k+4] = str(int(players_list[k+4]) - amount)
                market_list[2] = str(int(market_list[2])+amount)
                market_list[3] = str(float(market_list[3])-market_mult(market_list[3])*0.9*amount*1000/math.sqrt(int(market_list[2])+1))
                y = await context.bot.send_message(update.effective_chat.id, text="Господин, " + str(update.effective_user.first_name) + ", ваш капитал:\n" + players_list[k+1] + "$ R: " + players_list[k+2] + " G: " + players_list[k+3] + " B: " + players_list[k+4])
                messages.append(y.message_id) 
            else:
                y = await context.bot.send_message(chat_id=update.effective_chat.id, text=("Господин, " + str(update.effective_user.first_name) + ", транзакция неудачна!"))
...
async def side(update, context):
    ...
    message = str(update.effective_message.text)
    players = open('generals.txt', 'r', encoding="utf-8")
    players_list = players.read().splitlines()
    players.close()
    found = 0
    for k in range(len(players_list)):
        if str(update.effective_user.id) == players_list[k]:
            found = 1
            army = players_list[k+1]
            R = str((players_list[k+2]))
            G = str(int(players_list[k+3])*100)
            B = str(int(players_list[k+3])*10)  
            y = await context.bot.send_message(update.effective_chat.id, text="Генерал " + army + " " + str(update.effective_user.first_name) + ", у вас:\n" + R + " артиллерии\n" + G + " пехоты\n" + B + " бронетехники\n")
            messages.append(y.message_id) 
            break
    if found == 0:
        if "ru" in message:
            players = open('generals.txt', 'a', encoding="utf-8")
            players.write(str(update.effective_user.id) + "\n" + "РФ" + "\n" + "0" +  "\n"  + "0" +  "\n"  + "0" +  "\n")
            players.close()
